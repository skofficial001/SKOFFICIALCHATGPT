...
if SOURCE != s:
    print("𝗸𝗮𝗿 𝗹𝗶𝘆𝗮 𝗲𝗱𝗶𝘁 𝗺𝗶𝗹 𝗴𝘆𝗮 𝘀𝘂𝗸𝗼𝗼𝗻 𝗷𝗲𝘀𝗮 𝘁𝗵𝗮 𝘄𝗲𝘀𝗮 𝗸𝗮𝗿𝗱𝗲 ` https://github.com/DAXXTEAM/DAXXCHATGPT `  𝗻𝗵𝗶 𝘁𝗼 𝗷𝗮𝗸𝗲 𝐓𝐎𝐗𝐈𝐂 𝐁𝐎𝐘 𝗸𝗼 𝗯𝗼𝗹 𝗱𝗼 𝘁𝗵𝗶𝗸 𝗸𝗮𝗿 𝗱𝗲𝗴𝗮")
    sys.exit(1)  
...
if __name__ == "__main__":
    ...
    𝐓𝐇𝐈𝐒 𝐑𝐄𝐏𝐎 𝐌𝐀𝐃𝐄 𝐁𝐘 𝐒𝐊 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋🥳
 {BOT_NAME} ɪs ᴀʟɪᴠᴇ!  
    """)
    idle()
    DAXX.stop()
    print("𝐒𝐊 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 𝗖𝗛𝗔𝗧𝗚𝗣𝗧 𝗕𝗢𝗧 𝗦𝗧𝗢𝗣 !")
